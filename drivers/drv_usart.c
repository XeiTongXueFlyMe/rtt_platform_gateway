...
#define HW_USART_DMA_NUM          (sizeof(hw_usart_object_list) / sizeof(struct hw_usart_object))
...
struct hw_usart_object hw_usart_object_list[] =
{
#if (defined HW_USART_USING_UART1)  
  {
    ...
    .dma_tx_flags = DMA_FLAG_FEIF7 | DMA_FLAG_DMEIF7 | DMA_FLAG_TEIF7 | DMA_FLAG_HTIF7 | DMA_FLAG_TCIF7,
    .dma_rx_flags = DMA_FLAG_FEIF2 | DMA_FLAG_DMEIF2 | DMA_FLAG_TEIF2 | DMA_FLAG_HTIF2 | DMA_FLAG_TCIF2,
    .baud         = 115200,
    .irq_ch       = USART1_IRQn,
  },
#endif
...
#if (defined HW_USART_USING_UART2)  
  {
    ...
    .dma_tx_flags = DMA_FLAG_FEIF6 | DMA_FLAG_DMEIF6 | DMA_FLAG_TEIF6 | DMA_FLAG_HTIF6 | DMA_FLAG_TCIF6,
    .dma_rx_flags = DMA_FLAG_FEIF5 | DMA_FLAG_DMEIF5 | DMA_FLAG_TEIF5 | DMA_FLAG_HTIF5 | DMA_FLAG_TCIF5,
    .baud         = 115200,
    .irq_ch       = USART2_IRQn,
  },
#endif
...
#if (defined HW_USART_USING_UART3)  
  {
    ...
    .dma_tx_flags = DMA_FLAG_FEIF3 | DMA_FLAG_DMEIF3 | DMA_FLAG_TEIF3 | DMA_FLAG_HTIF3 | DMA_FLAG_TCIF3,
    .dma_rx_flags = DMA_FLAG_FEIF1 | DMA_FLAG_DMEIF1 | DMA_FLAG_TEIF1 | DMA_FLAG_HTIF1 | DMA_FLAG_TCIF1,
    .baud         = 115200,
    .irq_ch       = USART3_IRQn,
  },
#endif
...
#if (defined HW_USART_USING_UART4)  
  {
    ...
    .dma_tx_flags = DMA_FLAG_FEIF4 | DMA_FLAG_DMEIF4 | DMA_FLAG_TEIF4 | DMA_FLAG_HTIF4 | DMA_FLAG_TCIF4,
    .dma_rx_flags = DMA_FLAG_FEIF2 | DMA_FLAG_DMEIF2 | DMA_FLAG_TEIF2 | DMA_FLAG_HTIF2 | DMA_FLAG_TCIF2,
    .baud         = 115200,
    .irq_ch       = UART4_IRQn,
  },
...
static void _usart_configuration(void)
{
  ...
  for (i = 0; i < HW_USART_DMA_NUM; i++)
  {
    ...
    usart_obj->dma_tx_cfg.DMA_PeripheralBaseAddr = (uint32_t)&usart_obj->usart->DR;
    usart_obj->dma_tx_cfg.DMA_PeripheralDataSize = DMA_PeripheralDataSize_Byte;
    ...
    usart_obj->dma_rx_cfg.DMA_PeripheralBaseAddr = (uint32_t)&usart_obj->usart->DR;
    usart_obj->dma_rx_cfg.DMA_PeripheralDataSize = DMA_PeripheralDataSize_Byte;
...
static rt_size_t dma_transmit(struct rt_serial_device *serial, rt_uint8_t *buf, rt_size_t size, int direction){
  if(RT_SERIAL_DMA_RX != direction)
    return 0;
...
//     usart_obj->rx_length = HW_USART_BUFFER_RSIZE - DMA_GetCurrDataCounter(usart_obj->dma_rx_Stream);
//     if (usart_obj->rx_length > 0)
//     {
//       /* Indicate data receive */
//       rt_hw_serial_isr(&(usart_obj->serial), RT_SERIAL_EVENT_RX_DMADONE | (usart_obj->rx_length << 8));
